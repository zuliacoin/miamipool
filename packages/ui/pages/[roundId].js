...
export default function Round() {
    ...
    const [round, setRoundData] = useState(null);
    ...
    useEffect(() => {
        async function getRoundData() {
            let roundId = parseInt(router.query.roundId)
            let data = {}
        ...
        getRoundData()
        setContribution(0)
        getContribution(parseInt(router.query.roundId)).then((result) => setContribution(result))
    ...
    async function getContribution(roundId) {
        ...
        let contribution = await callReadOnlyFunction({
            ...
            functionArgs: [uintCV(id), uintCV(roundId)],
            network: NETWORK,
            senderAddress: GENESIS_CONTRACT_ADDRESS,
        })
                ...
                <Navbar/>
                    ...
                    <div className={styles.dashboard}>
                        ...
                        <div className={styles.secondRow}>
                            ...
                            {!round.hasMined && <div className={styles.hasClaimed}><p>Raising ends at #{round.blockHeight + ROUND_LEN}</p></div>}
                ...
                <Navbar/>
                    ...
                    <div>
                        ...
                        <div className={styles.secondRow}>
                            ...
                            {round.hasMined && <div className={styles.hasMined}><p>Mining has started</p></div>}
                            {!round.hasMined && <div className={styles.hasntMined}><p>Mining not started</p></div>}
                            {!round.hasMined && <div className={styles.endsAt}><p>Raising ends at #{round.blockHeight + ROUND_LEN}</p></div>}
